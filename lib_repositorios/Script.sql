...
('Terror'), ('Ciencia Ficci�n'), ('Documental');
...
('Pel�cula', 'Producci�n cinematogr�fica de larga duraci�n'),
('Serie', 'Producci�n dividida en temporadas y cap�tulos'),
...
('Isabella', 'Hern�ndez', 'isah', '525512345678', 'isabella.h@gmail.com', 'isa_mex', '1999-12-01'),
...
('Hans', 'M�ller', 'hansm', '4915123456789', 'hans.mueller@outlook.com', 'germany99', '1982-06-17'),
...
('Caracol Televisi�n', 1, 'Estudio colombiano de televisi�n y cine'),
...
('Televisa Estudios', 2, 'Estudio mexicano con amplia producci�n televisiva'),
...
('Mediaset Espa�a', 4, 'Productora y distribuidora espa�ola de contenido'),
('Patagonik Film Group', 3, 'Estudio argentino de cine y animaci�n'),
('Pol-ka Producciones', 3, 'Productora argentina de televisi�n y cine');
...
('Salma', 'Hayek', '1966-09-02', 'Actriz mexicana nominada al �scar'),
...
('Kaya', 'Braga', '2001-10-14', 'Actor brasile�o emergente');

INSERT INTO [Contents] ([Name], [Description], [ContentType], [Year], [Language], [Studio], [Person]) VALUES
('La Ni�a', 'Serie basada en hechos reales del conflicto en Colombia', 2, '2016-01-01', 1, 2, 2),
('El P�ramo', 'Pel�cula de suspenso en los Andes colombianos', 1, '2011-01-01', 6, 3, 3),
('Frontera Verde', 'Serie de suspenso y fantas�a en la Amazon�a', 2, '2019-01-01', 1, 5, 5),
('Mar�a Llena Eres de Gracia', 'Pel�cula sobre una joven colombiana y el narcotr�fico', 1, '2004-01-01', 1, 3, 4),
('Narcos', 'Serie sobre la historia de Pablo Escobar', 2, '2015-01-01', 2, 5, 1),
('El Robo del Siglo', 'Miniserie basada en el asalto al Banco de la Rep�blica en 1994', 2, '2020-01-01', 1, 3, 7),
('Monos', 'Pel�cula de drama y suspenso sobre j�venes guerrilleros en la selva', 1, '2019-01-01', 1, 3, 3),
('Roma', 'Pel�cula aclamada ambientada en la Ciudad de M�xico de los a�os 70', 1, '2018-01-01', 1, 7, 9),
('Nosotros los Nobles', 'Comedia mexicana sobre una familia adinerada en crisis', 1, '2013-01-01', 3, 6, 8),
('El secreto de sus ojos', 'Thriller ganador del �scar a Mejor Pel�cula Extranjera', 1, '2009-01-01', 1, 13, 10),
('Casi �ngeles', 'Serie juvenil argentina de romance y drama', 2, '2007-01-01', 1, 14, 20),
('�lite', 'Serie espa�ola de misterio y drama adolescente', 2, '2018-01-01', 1, 12, 21),
('Volver', 'Pel�cula de Pedro Almod�var sobre familia y secretos', 1, '2006-01-01', 4, 12, 13),
('Inception', 'Pel�cula de ciencia ficci�n dirigida por Christopher Nolan', 1, '2010-01-01', 2, 9, 14),
('Pulp Fiction', 'Pel�cula de culto dirigida por Quentin Tarantino', 1, '1994-01-01', 2, 11, 15),
('Tropa de �lite', 'Pel�cula sobre la violencia urbana y el BOPE en R�o de Janeiro', 1, '2007-01-01', 3, 8, 16),
('Ciudad de Dios', 'Pel�cula brasile�a sobre crimen organizado en las favelas', 1, '2002-01-01', 3, 8, 17);
...
(1, 'El inicio de la ni�a', 1, 'Primera temporada de La Ni�a', '2016-04-01'),
...
(2,'Ca�da del Imperio',5,'Segunda temporada que narra la guerra con los carteles rivales','2016-10-05'),
(1,'El �ltimo Asalto',6,'Miniserie completa sobre el plan maestro del robo','2020-01-15'),
...
(3, 1,'El guardi�n','00:53:00','Un ser inesperado protege un secreto milenario'),
(5, 1,'Nacimiento de un imperio','00:55:00','Un joven l�der comienza a forjar su reputaci�n'),
...
(7, 1,'La �ltima fogata','00:51:00','Una noche marca un antes y un despu�s en la guerrilla'),
...
(2, 'Me encant� la fotograf�a', 4, '2011-09-15', 2),
...
(3,'Excelente producci�n, la atm�sfera es �nica',4,'2022-01-20',3),
...
(9,'Divertid�sima, no par� de re�r',5,'2020-03-10',9),
...
(15,'Un cl�sico que nunca envejece',5,'2017-07-23',15),
