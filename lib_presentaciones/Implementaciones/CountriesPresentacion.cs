...
namespace lib_presentaciones.Implementaciones
{
    public class CountriesPresentacion : ICountriesPresentacion
    {
        ...
        public async Task<List<Countries>> Listar(string llave)
        {
        ...
        public async Task<Countries?> Guardar(Countries? entidad, string llave)
        {
            if (entidad!.Id != 0)
            {
        ...
        public async Task<Countries?> Modificar(Countries? entidad, string llave)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
        ...
        public async Task<Countries?> Borrar(Countries? entidad, string llave)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
