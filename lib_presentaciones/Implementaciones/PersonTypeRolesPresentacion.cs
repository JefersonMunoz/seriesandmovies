...
namespace lib_presentaciones.Implementaciones
{
    public class PersonTypeRolesPresentacion : IPersonTypeRolesPresentacion
    {
        ...
        public async Task<List<PersonTypeRoles>> Listar(string llave)
        {
        ...
        public async Task<List<PersonTypeRoles>> PorTypeRoles(PersonTypeRoles? entidad, string llave)
        {
            var lista = new List<PersonTypeRoles>();
            var datos = new Dictionary<string, object>();
        ...
        public async Task<PersonTypeRoles?> Guardar(PersonTypeRoles? entidad, string llave)
        {
            if (entidad!.Id != 0)
            {
        ...
        public async Task<PersonTypeRoles?> Modificar(PersonTypeRoles? entidad, string llave)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
        ...
        public async Task<PersonTypeRoles?> Borrar(PersonTypeRoles? entidad, string llave)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
