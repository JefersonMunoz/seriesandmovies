...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private ILanguagesPresentacion? iPresentacion = null;
        public LanguagesModel(ILanguagesPresentacion iPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                //Filtro = new Languages();
        ...
        [BindProperty] public Languages? Actual { get; set; }
        [BindProperty] public List<Languages>? Lista { get; set; }
