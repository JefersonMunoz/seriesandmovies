...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private ICountriesPresentacion? iPresentacion = null;
        public CountriesModel(ICountriesPresentacion iPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                //Filtro = new Countries();
                //Lista = new List<Countries>();
            }
            catch (Exception ex)
            {
        ...
        [BindProperty] public Countries? Actual { get; set; }
        [BindProperty] public List<Countries>? Lista { get; set; }
